...
def extract(page, numOfPost, infinite_scroll=False, scrape_comment=False):
    ...
    if scrape_comment:
        ...
        # moreComments = browser.find_elements_by_xpath('//a[@class="d2edcug0 hpfvmrgz qv66sw1b c1et5uql rrkovp55 a8c37x1j keod5gw0 nxhoafnm aigsh9s9 d3f4x2em fe6kdd0r mau55g9w c8b282yb iv3no6db jq4qci2q a3bd9o3v lrazzd5p m9osqain"]')
